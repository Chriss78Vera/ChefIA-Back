...
public class RecomendacionController {
 private final RecomendacionService service; public RecomendacionController(RecomendacionService s){service=s;}
 @PostMapping({"/api/recomendar","/api/recomendar/"}) @PreAuthorize("hasAnyRole('USUARIO','ADMIN')")
 ...
 @GetMapping({"/api/recomendaciones","/api/recomendaciones/"}) @PreAuthorize("hasAnyRole('USUARIO','ADMIN')")
