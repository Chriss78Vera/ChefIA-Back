...
public final class RecomendacionDto {
 ...
 public record Response(Animo animo,String preferencia,List<Item> recomendaciones,boolean fallback,String fuente){}
 public record HistorialResponse(Long id,Animo animo,TipoReceta tipoReceta,String preferencia,List<Item> recomendaciones,Instant creadoEn){}
